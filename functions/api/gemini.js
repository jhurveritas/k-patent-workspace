...
[역할 및 목적]
당신은 특허 검색식 작성 최고 전문가입니다. 첨부된 특허 문헌들을 모두 정확하고 노이즈 없이 도출해 내되, 반드시 '사용자가 허용한 필드 연산자'만을 사용해서 검색식을 작성해야 합니다.
...
\`\`\`
### 2. 💡 검색식 구성 논리 및 해설
(적용된 규칙, 키워드 매칭 논리 등을 간략히 해설)`;

            parts.push({ text: "위 규칙을 완벽하게 반영하여 첨부된 문헌들을 찾아낼 수 있는 최적화된 검색식을 도출해 주세요." });

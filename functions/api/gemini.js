...
3. 미보정 청구항 동일 간주: [보정서 원문]에 기재되지 않은(생략된) 청구항들은 함께 제공된 [보정 전 명세서]에 기재된 대응 청구항들과 내용이 완전히 동일하게 유지된 것으로 간주하시오.
4. 청구항 임의 삭제/변경 절대 금지: 의견서 본문 작성 시, [보정서 원문]에 기재된 모든 청구항은 절대로 임의로 삭제하거나 내용을 변경하지 마시오.

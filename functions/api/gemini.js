...
어떤 분석이나 문서 읽기를 시작하기 전에, 가장 먼저 무조건 아래 문장을 즉시 출력하십시오:
"🌐 **번역 정확도 검토를 시작합니다...**\n\n"
이 문장을 화면에 뱉어낸 후에야 비로소 청구항을 읽고 번역 오류(누락, 오역 등) 검증을 시작하십시오.
...
어떤 분석이나 문서 읽기를 시작하기 전에, 가장 먼저 무조건 아래 문장을 즉시 출력하십시오:
"⚖️ **영문 기재불비 검토를 시작합니다...**\n\n"
이 문장을 화면에 뱉어낸 후에야 비로소 청구항을 읽고 기재불비 요소 검증을 시작하십시오.

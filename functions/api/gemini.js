...
3. 청구항 임의 삭제/변경 절대 금지 (매우 중요): [보정서 원문]에 기재된 모든 청구항은 내용이 중복되거나 논리적 오류가 있어 보이더라도 절대로 임의로 삭제하거나 내용을 변경하지 마십시오. 사용자가 제공한 청구항 및 대응 논리를 그대로 유지하여 의견서 본문을 작성해야 합니다.

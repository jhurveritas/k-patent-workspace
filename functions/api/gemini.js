...
4. 인접 연산자 "N/n": 텍스트 검색 필드(TAC, DSC, CLA 등)에서 유사한 키워드를 포함하는 괄호들 간에 위치가 서로 인접할 가능성이 높은 경우이거나 특정 키워드가 노이즈를 많이 포함할 수 밖에 없는 경우에는 인접 연산자("N/n", n은 7 이하)를 사용하세요. 단, "N/n" 이 2번이상 연속적으로 연산되도록 사용하지 마세요.

...
8. 🚨 필드 스코프(Scope) 무결성 보장: 모든 검색 키워드와 내부 연산(AND, OR, N/n)은 반드시 해당 필드 연산자의 가장 바깥쪽 괄호 안에 완벽하게 갇혀 있어야 합니다. (좋은 예: DSC:(((A A') N/5 (B B')) AND (C C')))
9. 🚨 [최종 검증 단계 - 매우 중요]: 검색식을 최종 출력하기 전에, 아래 사항을 확인하세요.
    ...
    - 검색식의 괄호 개수가 짝수 개로 대응되는지 확인하고, 대응되지 않는 경우에는 8번의 예시를 참조해서 수정하세요.

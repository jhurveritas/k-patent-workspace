...
6. 💡 유사어 극대화 및 [1음절 한글 키워드 제어]: 
   ...
   - 🚨 1음절(한 글자) 한글 단어는 노이즈가 매우 심하므로 원칙적으로 사용을 금지하고 2음절 이상의 동의어로 대체하세요.
   - 🚨 부득이하게 1음절 한글 단어를 꼭 써야만 한다면, 단독으로 쓰거나 *를 붙이지 말고, 발생 가능한 주요 조사를 모두 붙인 형태들을 공백(OR)으로 묶어서 사용하세요. (예: ("망이" "망은" "망을" "망에" "망의" "망으로"))

...
4. 인접 연산자 N/n: 텍스트 검색 필드(TAC, DSC, CLA 등)에서 동일 또는 유사한 키워드 괄호 간에 위치가 인접할 가능성이 높은 경우에는 인접 연산자(N/n, n은 7 이하)를 사용하세요. 단, 동일한 키워드와 관련된 구성을 포함하는 괄호 내에서는 N/n 사용은 한번만 하세요.

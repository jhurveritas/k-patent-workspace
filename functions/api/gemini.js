...
4. 인접 연산자 (N/n) 엄격 제한: 노이즈가 우려되거나 키워드 간 위치가 가까운 경우 N/n(여기서 n은 2~7이고, (A N/n B)와 같이 N/n을 활용한 식은 다음 연산자가 나오기 전에 괄호로 닫혀야함.)을 활용하되, "N/n"을 꼬리를 물고 연속으로 체인 결합하지 마세요. (나쁜 예: A N/5 B N/5 C / 좋은 예: ((A) N/5 (B)) AND C). "/" 기호 생략 금지.
5. 구문 검색 (""): 띄어쓰기가 포함된 복합 명사는 반드시 큰따옴표("")로 묶어 검색. 범위가 너무 좁아지면 N/n 연산자로 우회할 것.
6. 대체문자 (*)사용 가이드: "*" 사용 시, 영문의 경우 과거형, 분사형, 현재진행형, 형용사 등으로의 단어형태 변경을 고려하여 원천적인 의미를 가지는 원형 단어에 붙여서 한 단어로 나타낼 것 (예: brak*, electr*, park* 등)

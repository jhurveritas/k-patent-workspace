...
3. 자체 판단 금지: 사용자의 [보정서 원문] 및 [대응 초안 (핵심 논리)]의 내용을 절대 변경하지 마십시오.
4. 마크다운 볼드체 금지: 출력 결과물 전체에서 '**' 기호를 절대 사용하지 마십시오.
5. 부록(Appendix) 작성 의무: 의견서 본문 작성이 모두 끝난 후, 문서 맨 마지막에 구별되는 구분선(---)을 긋고 다음 두 가지 항목을 반드시 별도로 요약해 주십시오.
   - [AI 보충 추천]: AI가 논리적 완성도를 높이기 위해 부득이하게 추가로 살을 붙인 부분과 추가적으로 보충되면 좋을 논리
   - [기재불비 점검]: [보정서 원문]의 청구항에 대해 선행사 불일치 및 삭제된 청구항 인용 등 기재불비 사항이 남아있는지 점검한 결과
